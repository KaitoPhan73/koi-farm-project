...
export default function HomeScreen() {
    ...
    const renderBlogItem = ({ item }: { item: Blog }) => (
        ...
        >
            ...
            <Text style={styles.blogDescription} numberOfLines={2} ellipsizeMode="tail">
                {item.description}
            </Text>
        </TouchableOpacity>
    );
    ...
    return (
        <ScrollView className="flex-1">
            ...
            <ImageBackground source={nenbien} resizeMode="cover">
                ...
                <View style={styles.serviceContainer}>
                    <View style={styles.serviceCard}>
                        ...
                        <View style={styles.ScontentContainer}>
                            <Text style={styles.ScontentTitle}>Tiện lợi</Text>
                            <Text style={styles.ScontentTitle}>An toàn</Text>
                            <Text style={styles.Scontent}>
                                Chúng tôi luôn mang lại dịch vụ tối ưu và đảm bảo an toàn cho
                                "dế cưng" của bạn
                            </Text>
                        </View>
                    </View>
                ...
                {/* Blog section */}
                <Text style={styles.serviceTitle}>Các Blog Cá Nhân</Text>
                <FlatList
                    data={displayedBlogs}
